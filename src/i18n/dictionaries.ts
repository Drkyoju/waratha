  ...
  howItWorks: {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          "تقرير مرتّب ومتوافق مع معايير ACMG يُبرز المتغيرات الأكثر احتمالاً أن تكون مرضية — بالعربية والإنجليزية — لمراجعتها وتأكيدها من قِبل أخصائي الوراثة السريري.",
      },
    ],
  },
  solution: {
